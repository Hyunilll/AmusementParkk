...
<input type="button" value="이용문의" class="submit" onclick="location.href='world.do?command=qnaList&page=1'" style="display: inline-block; font-size: 18px;font-weight:bold; background: #CCFF99;color: black; border: 2px solid #fff; border-radius: 30px; padding: 14px 58px; margin-top: 40px;">
</h3></p>
  </div>
 <br><br><br>
 <div id="board-search">
